          ...
          <form className="space-y-6" action="#" method="POST">
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  focus:ring-2 focus:ring-inset focus:ring-[#FF5722] sm:text-sm sm:leading-6"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  required
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset 
                  ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#FF5722] 
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  focus:ring-[#FF5722] sm:text-sm sm:leading-6"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  type="file"
                  required
                  className="block w-full rounded-md border-0 py-1.5 ps-3  text-gray-900 shadow-sm ring-1 ring-inset 
            ...
            <div>
              <button
                ...
                text-white shadow-sm hover:bg-[#FF572295] focus-visible:outline focus-visible:outline-2 
