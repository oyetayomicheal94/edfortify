...
const DeleteSubject = ({ isOpen, onClose }) => {
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
              <form className="space-y-6" action="#" method="POST">
                <div>
                  <button
                    type="submit"
                    className="flex w-full justify-center rounded-md bg-red-600 px-3 py-1.5 text-sm font-semibold leading-6 
                ...
                <div>
                  <button
                    type="submit"
                    className="flex w-full justify-center rounded-md bg-[#4CAF50] px-3 py-1.5 text-sm font-semibold 
                    leading-6 text-white shadow-sm hover:bg-[#4CAF5095] focus-visible:outline focus-visible:outline-2 
                    focus-visible:outline-offset-2 focus-visible:outline-[#4CAF50]"
                  >
                    No
                  </button>
                </div>
